                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2 text-sm text-gray-600">
                              <Badge variant="secondary">
                                {categories[labour.category]?.name || labour.category}
                              </Badge>
                              {labour.isVerified && (
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {categories[booking.category]?.name || booking.category} • {booking.labourCount} worker(s)
                            </p>
                          </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-md max-h-[90vh] overflow-y-auto">
        <CardHeader>
          ...
          <CardDescription>
            {categories[labour.category]?.name || labour.category} • {labour.experience} years experience • ⭐ {labour.rating}
          </CardDescription>
          {city && (
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              <MapPin className="w-4 h-4" />
